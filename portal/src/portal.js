...
async function init() {
    ...
    loadingPromises.push(loadApp('app4-a', '/app4-a', '/app4-a/singleSpaEntry.js', null, null)); // does not have a store, so we pass null

    // loadingPromises.push(loadApp('app-nav', '/app-nav', '/nav/singleSpaEntry.js', null, null)); // does not have a store, so we pass null
